//document.getElementById('header').style.backgroundColor = '#24BEE5'
function style_page(company){
        ...
        if(company=="1"){
            ...
            for(var i = 0; i < cls.length; i++){
                    ...
                    document.getElementsByClassName('header')[i].style.borderBottom = "5px solid #24BEE5";
            }
            ...
            var t = document.createTextNode("#footer-nav{background-color:#24BEE5; border:1px solid #24BEE5}");
            x.appendChild(t);
            ...
            var c = document.createTextNode(".scbar h3,h4,h2{color:#24BEE5}");
            b.appendChild(c);
            document.head.appendChild(b);

            for(var i = 0; i < fot.length; i++){
                fot[i].innerHTML = "<i>NOPADOL Inventory V0.2  BY IT nopadol</i>";
            }
            ...
            var fot = document.getElementsByClassName('ftext');
                 ...
                 for(var i = 0; i < fot.length; i++){
                      fot[i].innerHTML = "<i>NAVA Inventory V0.2  BY IT nopadol</i>";
                 }

                    var x = document.createElement("STYLE");
                    var t = document.createTextNode("#footer-nav{background-color:#7ccb1c; border:1px solid #7ccb1c}");
                    x.appendChild(t);
                    document.head.appendChild(x);
                    ...
                    var b = document.createElement("STYLE");
                    var c = document.createTextNode(".scbar h3,h4,h2{color:#7ccb1c}");
                    b.appendChild(c);
                    document.head.appendChild(b);
                 ...
                 var cls = document.getElementsByClassName('header');
                 for(var i = 0; i < cls.length; i++){
                       document.getElementsByClassName('header')[i].style.backgroundImage = "url('images/inven_logo.png')";
                       document.getElementsByClassName('header')[i].style.backgroundRepeat = "no-repeat";
                       document.getElementsByClassName('header')[i].style.borderBottom = "5px solid #413fa0";
                 }
                 var form = document.getElementsByClassName('feedback-input');
                 for(var i = 0; i < form.length; i++){
                      form[i].style.color = "#413fa0";
                 }
                 var bt = document.getElementsByClassName('button-green');
                 for(var i = 0; i < bt.length; i++){
                      bt[i].style.backgroundColor = "#413fa0";
                 }
